  ...
  return (
    <div className='absolute inset-0 flex flex-col px-10'>
      ...
      <div className='absolute bottom-3 left-3 right-3 flex items-center justify-end gap-2 rounded-lg bg-sky-600/80 p-4 pl-5  backdrop-blur-sm md:gap-4 md:pl-7'>
        <button className='rounded-md bg-rose-700 px-4 py-2 text-lg font-semibold text-gray-50 hover:bg-rose-800 focus:outline-none focus:ring-2 focus:ring-rose-700 focus:ring-offset-2 focus:ring-offset-sky-600/80 lg:w-auto'>
          Delete
        </button>
